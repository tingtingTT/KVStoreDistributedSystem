...
if __name__ == "__main__":
    ...
    if 1 in tests_to_run:
        ...
        try:
            # Test 1
            test_description = """start 4 nodes then add 3 nodes then remove 3 nodes """
    ...
    if 2 in tests_to_run:
        ...
        try:  # Test 2
            ...
            I send 60 randomly generated keys to the kvs.
            ...
            print('num keys has to be 60 ',add_keys)
